                ...
                @foreach($services as $s)
                    <tr class="hover:bg-pink-50 transition">
                        ...
                        <td class="px-6 py-3 text-center space-x-2">
                            ...
                            <form action="{{ route('admin.services.destroy', $s->service_id) }}" 
    ...
    <template x-teleport="body">
        <div x-cloak x-show="createModal"
            ...
            <div class="bg-white rounded-xl p-6 w-[480px] shadow-lg"
                 @click.outside="createModal = false" x-transition.scale>
    ...
    <template x-teleport="body">
        <div x-cloak x-show="editModal"
            ...
            <div class="bg-white rounded-xl p-6 w-[480px] shadow-lg" x-transition.scale>
                ...
                <form method="POST" :action="'/admin/services/' + selected.service_id">
                    @csrf
                    @method('PUT')
